...
class TestProcessDescription:
    ...
    def test_html_entity_decoding(self):
        ...
        assert " with team&stakeholders" in result or "Meeting with team&stakeholders" in result
        assert "&nbsp;" not in result
        assert "&amp;" not in result
    ...
    def test_max_length_truncation(self):
        ...
        result = EventsService.process_description(description, mode="full", max_length=30)
    ...
    def test_max_length_truncation_at_word_boundary(self):
        ...
        result = EventsService.process_description(description, mode="full", max_length=20)
...
# Import MagicMock at top for recurring event test
