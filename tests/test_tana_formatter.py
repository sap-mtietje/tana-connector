...
class TestFormatEvents:
    ...
    def test_event_with_category_tags_no_categories(self, sample_event):
        ...
        result = TanaFormatter.format_events([sample_event], tag="meeting", include_category_tags=True)
        assert "#[[meeting]]" in result
    
    def test_filter_fields(self, sample_event):
        """Should only show specified fields"""
        result = TanaFormatter.format_events([sample_event], filter_fields=["title", "date", "location"])
    ...
    def test_start_end_fields(self, sample_event):
        ...
        result = TanaFormatter.format_events([sample_event], filter_fields=["start", "end"])
...
class TestShouldDisplay:
    ...
    def test_field_not_in_filter(self):
        ...
        assert not TanaFormatter._should_display("Status", "Accepted", ["location"], True)
