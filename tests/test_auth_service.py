...
class TestAuthService:
    ...
    def test_load_auth_record_success(
        self, mock_record_class, mock_path
    ):
    ...
    @patch("app.services.auth_service.AUTH_RECORD_PATH")
    @patch("app.services.auth_service.AuthenticationRecord")
    def test_load_auth_record_handles_error(
        self, mock_record_class, mock_path
    ):
    ...
    def test_save_auth_record_success(self, mock_path):
        ...
        mock_path.write_text.assert_called_once_with('{"some": "data"}', encoding="utf-8")
